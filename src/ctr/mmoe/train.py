...
from ctr.mmoe.model import MMOE
...
with mirrored_strategy.scope():
    mmoe = MMOE(cate_feature_columns=cate_feature_dict, cate_feature_dict=[user_cate_feature_dict, item_cate_feature_dict])
    model = mmoe.build_graph()
    model.summary()
    # ============================Compile============================
...
# ============================model checkpoint======================
# check_path = '../save/mmoe_weights.epoch_{epoch:04d}.val_loss_{val_loss:.4f}.ckpt'
